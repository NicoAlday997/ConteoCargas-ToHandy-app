...
import { COLORES, ESPACIADO, RITMO, TONOS, TOQUE_MINIMO, type ClaveColor } from './tokens.ts';
...
describe('ritmo de espaciado', () => {
  ...
  it('más aire entre secciones que entre componentes, y más entre componentes que dentro de uno', () => {
    assert.ok(RITMO.seccion > RITMO.relacionado && RITMO.relacionado > RITMO.interno);
  });
});
